...
(window || exports).Serializer = (function(){
  ...
  Serializer.protokey = 1;

  Serializer.register = function(prototype){
    var protokey = String(this.protokey++);
    this.prototypes[protokey] = prototype;
    return protokey;
  };
  ...
  Serializer.dereference = function(value, denormalized){
    ...
    var object = denormalized[value.$r];
  ...
  Serializer.denormalizeObject = function(normalizedObject, denormalizedObject, denormalized){
    ...
    if(denormalizedObject.protokey)
      denormalizedObject.__proto__ = this.prototypes[denormalizedObject.protokey];
  };
